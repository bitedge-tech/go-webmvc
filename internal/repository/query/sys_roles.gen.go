...
func newSysRole(db *gorm.DB, opts ...gen.DOOption) sysRole {
	...
	_sysRole.RoleDesc = field.NewString(tableName, "role_desc")
	...
	_sysRole.Status = field.NewInt(tableName, "status")
	_sysRole.SysMenu = sysRoleManyToManySysMenu{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("SysMenu", "model.SysMenu"),
		SysRole: struct {
			field.RelationField
			SysMenu struct {
				field.RelationField
			...
			RelationField: field.NewRelation("SysMenu.SysRole", "model.SysRole"),
			SysMenu: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("SysMenu.SysRole.SysMenu", "model.SysMenu"),
			},
		},
	}
...
type sysRole struct {
	...
	RoleDesc  field.String
	CreatedAt field.Time
	CreatedBy field.Int64
	UpdatedAt field.Time
	UpdatedBy field.Int64
	Status    field.Int
	SysMenu   sysRoleManyToManySysMenu
...
func (s *sysRole) updateTableName(table string) *sysRole {
	...
	s.RoleDesc = field.NewString(table, "role_desc")
...
func (s *sysRole) fillFieldMap() {
	...
	s.fieldMap["role_desc"] = s.RoleDesc
...
func (s sysRole) clone(db *gorm.DB) sysRole {
	...
	s.SysMenu.db = db.Session(&gorm.Session{Initialized: true})
	s.SysMenu.db.Statement.ConnPool = db.Statement.ConnPool
	return s
}

func (s sysRole) replaceDB(db *gorm.DB) sysRole {
	s.sysRoleDo.ReplaceDB(db)
	s.SysMenu.db = db.Session(&gorm.Session{})
	return s
}

type sysRoleManyToManySysMenu struct {
	db *gorm.DB
...
func (a sysRoleManyToManySysMenu) Where(conds ...field.Expr) *sysRoleManyToManySysMenu {
	if len(conds) == 0 {
		return &a
	}
...
func (a sysRoleManyToManySysMenu) WithContext(ctx context.Context) *sysRoleManyToManySysMenu {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a sysRoleManyToManySysMenu) Session(session *gorm.Session) *sysRoleManyToManySysMenu {
	a.db = a.db.Session(session)
	return &a
}

func (a sysRoleManyToManySysMenu) Model(m *model.SysRole) *sysRoleManyToManySysMenuTx {
	return &sysRoleManyToManySysMenuTx{a.db.Model(m).Association(a.Name())}
}

func (a sysRoleManyToManySysMenu) Unscoped() *sysRoleManyToManySysMenu {
	a.db = a.db.Unscoped()
	return &a
}

type sysRoleManyToManySysMenuTx struct{ tx *gorm.Association }

func (a sysRoleManyToManySysMenuTx) Find() (result []*model.SysMenu, err error) {
	return result, a.tx.Find(&result)
}

func (a sysRoleManyToManySysMenuTx) Append(values ...*model.SysMenu) (err error) {
...
func (a sysRoleManyToManySysMenuTx) Replace(values ...*model.SysMenu) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysRoleManyToManySysMenuTx) Delete(values ...*model.SysMenu) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a sysRoleManyToManySysMenuTx) Clear() error {
	return a.tx.Clear()
}

func (a sysRoleManyToManySysMenuTx) Count() int64 {
	return a.tx.Count()
}

func (a sysRoleManyToManySysMenuTx) Unscoped() *sysRoleManyToManySysMenuTx {
	a.tx = a.tx.Unscoped()
	return &a
}
